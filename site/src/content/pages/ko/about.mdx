...
| 저장소 | 개념 | 릴리즈 사다리 |
| --- | --- | --- |
| `day-01` | 원리 · 고급 루프 · 하네스 (예제 51종) | v0.1 뼈대 → v0.2 도구 → v0.3 [[react\|ReAct]] → v0.4 고급 루프 → v1.0 [[harness\|하네스]] |
...
- git과 Docker Desktop (설치 절차는 사전 준비 가이드에 있습니다)
...
- `day-01`: ReAct·Plan-and-Execute·Reflexion과 인젝션 방어까지 갖춘 여행 에이전트 + 예제 51종
