...
코드: [`01_provider_swap.py`](https://github.com/2026-ai-agents/day-01/blob/main/examples/02_litellm/01_provider_swap.py)
...
## 2. 3사 비교: 응답·지연·비용을 나란히

코드: [`02_three_way_compare.py`](https://github.com/2026-ai-agents/day-01/blob/main/examples/02_litellm/02_three_way_compare.py)
...
## 3. 폴백: 주 모델이 죽으면 이어받는다

코드: [`03_fallback.py`](https://github.com/2026-ai-agents/day-01/blob/main/examples/02_litellm/03_fallback.py)
...
## 4. 재시도와 타임아웃: 순간 장애의 방어

코드: [`04_retry_timeout.py`](https://github.com/2026-ai-agents/day-01/blob/main/examples/02_litellm/04_retry_timeout.py)
...
## 5. 캐싱: 같은 질문 두 번째는 공짜·즉시

코드: [`05_cache.py`](https://github.com/2026-ai-agents/day-01/blob/main/examples/02_litellm/05_cache.py)
...
## 6. 비용 콜백: 호출마다 장부에 쌓인다

코드: [`06_cost_callback.py`](https://github.com/2026-ai-agents/day-01/blob/main/examples/02_litellm/06_cost_callback.py)
...
## 7. rate limit: 백오프로 살아남기

코드: [`07_rate_limit.py`](https://github.com/2026-ai-agents/day-01/blob/main/examples/02_litellm/07_rate_limit.py)
...
## 8. 라우터: 별명 하나 뒤에 배포 여러 개

코드: [`08_router.py`](https://github.com/2026-ai-agents/day-01/blob/main/examples/02_litellm/08_router.py)
...
## 9. 모델 메타데이터: 한도와 단가를 코드로 읽는다

코드: [`09_model_info.py`](https://github.com/2026-ai-agents/day-01/blob/main/examples/02_litellm/09_model_info.py)
...
## 10. 임베딩: 같은 인터페이스의 다른 출구

코드: [`10_embedding.py`](https://github.com/2026-ai-agents/day-01/blob/main/examples/02_litellm/10_embedding.py)
