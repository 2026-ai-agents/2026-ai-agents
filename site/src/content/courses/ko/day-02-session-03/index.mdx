...
예약 한 건의 생애는 상태 네 값으로 흐릅니다. 이 흐름이 세션 전체의
지도입니다.
...
이 세션에는 "승인"이 두 번 나옵니다. **성격이 전혀 다르므로** 미리
갈라 둡니다.
...
재시작 생존도 유닛테스트 판이 있습니다. 새로 compile한 그래프(새 프로세스
흉내)가 같은 pg에서 대화를 이어받는지를 확인합니다.
