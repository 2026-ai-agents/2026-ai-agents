...
구조가 바뀌었으니 draw_mermaid를 다시 뽑습니다(색 지정만 걷어내고 렌더).
...
(`demos/semantic_recall.py`, 임베딩은 gemini-embedding-001).
...
전체(top-5)**를 싣습니다. 검색은 정답기가 아니라 깔때기입니다.
...
판단기가 죽어도 답변은 산다는 계약도 테스트 문장입니다.
