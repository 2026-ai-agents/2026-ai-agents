...
description: "examples/01_api 11종 전수 실행: 요청·응답 해부, 역할, 토큰과 비용, 한도 초과, 스트리밍, 병렬, 무상태, 기억과 compact, JSON 강제, 비전"
summary: "최소 호출의 요청·응답 JSON 원문에서 출발해, 역할·토큰·컨텍스트 한도·스트리밍·무상태·비용까지 API의 바닥을 예제 11종의 실제 실행 결과로 다집니다."
date: 2026-08-14
category: day-1
order: "3898"
level: 1
slides: ["day-01-session-02"]
...
- **참고**: 예제의 `completion()`은 [[litellm|LiteLLM]]의 통일 인터페이스입니다. 공식 SDK 대신 이것을 쓰는 이유는 [3세션 1번](/course/day-01-session-03/)에서 다룹니다
...
## 9. 기억의 정체: 채팅이 나를 기억하는 이유와 compact
