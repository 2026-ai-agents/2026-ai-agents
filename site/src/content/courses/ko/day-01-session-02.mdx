...
> ★ 표시는 수업 중 함께 실행하는 예제이고, 이 문서에는 **11종 전부의 실제
> 실행 결과**를 실었습니다.  
...
## 1. `01_hello_completion.py` ★ · 최소 호출의 원문
...
## 2. `02_roles.py` · system이 페르소나를 정한다
...
## 4. `04_context_limit.py` · 한도를 일부러 넘어 본다
...
## 7. `07_async_parallel.py` ★ · 병렬화의 효과
...
## 8. `08_multiturn_stateless.py` · 기억은 배열에 있다
...
## 10. `10_vision.py` · 이미지도 content 조각 하나
...
## 11. `11_cost_calc.py` · 비용을 손으로 계산한다
