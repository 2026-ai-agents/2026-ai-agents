...
| [4. secretary-agent](/course/day-02-session-04/) | `secretary-agent` | 장기 메모리([[store]]) | app · ui · db |
| [5. food-rag-agent](/course/day-02-session-05/) | `food-rag-agent` | [[agentic-rag\|Agentic RAG]]: 선별 깔때기와 검증자 | app · ui · db · rag |
