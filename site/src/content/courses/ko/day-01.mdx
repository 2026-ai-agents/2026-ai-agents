...
| [8. MCP 맛보기](/course/day-01-session-08/) | 도구를 표준으로 가져오기 | 시연 | — |

예제는 총 51종입니다. 이 중 ★ 표시 20종만 수업 중 실행·해설하고, 나머지는
자율 학습용입니다. 세션 문서에는 **51종 전부를 실제로 돌린 실행 결과**가
코드 발췌·해설과 함께 실려 있습니다. 2026-08-14 실측입니다.
