...
| [8. MCP 맛보기](/course/day-01-session-08/) | 도구를 표준으로 가져오기 | `examples/07_mcp/` 시연 3종 | → v1.1 |

예제는 총 51종이고 8세션의 MCP 시연 3종이 더해집니다. **전부 수업에서
...
| v1.1 | [[mcp\|MCP]] 시연 3종 추가 (examples/07_mcp) | 33개 |
