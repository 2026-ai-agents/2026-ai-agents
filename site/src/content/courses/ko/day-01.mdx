...
description: "Day 1 개요: day-01에서 LLM API의 본질, LiteLLM, tool calling, ReAct와 그 너머의 루프, 하네스까지"
summary: "프레임워크 없이 에이전트(여행 플래너)의 원리를 체득하고, ReAct 너머의 루프와 하네스(인젝션 방어·비용 가드)까지 다집니다. 교재는 day-01이며, compose로 lab 컨테이너 하나를 띄우고 모든 예제를 터미널에서 실행합니다."
date: 2026-08-14
category: day-1
slides: ["day-01"]
...
- **교재**: [day-01](https://github.com/2026-ai-agents/day-01)
